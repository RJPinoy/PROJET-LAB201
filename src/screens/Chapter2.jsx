        ...
        <>
            <div id="chapter_2" className="chapter_container">
                ...
                <div className="text">
                    ...
                    <p>
                        L'arrivée du hip-hop sur le territoire français est en grande partie attribuée à DJ Dee Nasty, considéré comme le pionnier en la matière. C'est à San Francisco, en 1975, qu'il découvre les prémices du mouvement, notamment à travers le breakdance.
                    </p>
                </div>
                <div className="images">
                    <img src="/Pics1.png" alt="Image" />
                    <img src="/Pics2.png" alt="Image" />
